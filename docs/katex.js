!(function(e, t) {
  ...
  return (function() {
    ...
    const v = [
      { name: 'latin', blocks: [[256, 591], [768, 879]] },
      ...
      toNode() {
        ...
        this.italic > 0 &&
          ...
          this.classes.length > 0 &&
            ((t = t || document.createElement('span')), (t.className = G(this.classes)))
        for (const e in this.style)
    ...
    const Te = [
      ...
      Ce = function(e, t, r) {
        return (
          oe[r][e] && oe[r][e].replace && (e = oe[r][e].replace), { value: e, metrics: N(e, t, r) })
      },
      ...
      for (let e = 0; e < n.length; e++)
        if (
          ...
          n[e].hasClass('newline') &&
            (a.pop(), a.length > 0 && (s.push(ct(a, t)), (a = [])), s.push(n[e]))
            ...
            (h = Ve.makeVList(
              {
                ...
                children: [
                  { type: 'elem', elem: s },
                  {
                    ...
                    wrapperStyle:
                      i > 0
                        ? { width: 'calc(100% - ' + F(2 * i) + ')', marginLeft: F(2 * i) }
                        : void 0
                  }]
              },
              t
    ...
    const Zt = function(e, t, r) {
      ...
      tr = function(e, t, r) {
        ...
        return (
          (i.height = t), (i.style.height = F(t)), (i.style.width = F(n)), { type: 'elem', elem: i })
      },
    ...
    const Sr = (e, t) => {
      ...
      Mr = (e, t) => {
        let r = 0
        const n = new gt.MathNode(e.label.indexOf('colorbox') > -1 ? 'mpadded' : 'menclose', [
          vt(e.body, t)])
        switch (e.label) {
          case '\\cancel':
    ...
    const Er = function(e, t) {
        ...
        for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
          ...
          ;(d = Ve.makeVList({ positionType: 'individualShift', children: d }, t)),
            ...
            (o < a - 1 || e.hskipBeforeAndAfter) &&
              ...
              0 !== i &&
                ((z = Ve.makeSpan(['arraycolsep'], [])), (z.style.width = F(i)), M.push(z)))
        }
      ...
      Dr = function(e, t) {
        ...
        return (
          ...
          '' !== a &&
            ((s = new gt.MathNode('menclose', [s])), s.setAttribute('notation', a.trim())),
          e.arraystretch &&
            e.arraystretch < 1 &&
    ...
    je({
      ...
      handler: (e, t, r) => {
        ...
        return (
          '' === l &&
            ((l = h), (l = l.replace(/^.*[\\/]/, '')), (l = l.substring(0, l.lastIndexOf('.')))),
      ...
      je({
        ...
        handler(e, t) {
          ...
          return (
            n.expect(s), n.switchMode(o), { type: 'styling', mode: n.mode, style: 'text', body: i })
        }
      }),
      je({
        type: 'text',
    ...
    const Jr = (e, t, r, n, o, s, i) => {
        ...
        if (c && h) {
          const t =
            n.fontMetrics().bigOpSpacing5 + h.elem.height + h.elem.depth + h.kern + e.depth + i
          m = Ve.makeVList(
            {
              positionType: 'bottom',
              positionData: t,
      ...
      en = (e, t) => {
        ...
        let a,
          h = !1
        if (
          (i.size === w.DISPLAY.size && o.symbol && !l.contains(Qr, o.name) && (h = !0), o.symbol)
        ) {
    ...
    class Vn {
      ...
      parseArguments(e, t) {
        ...
        for (let i = 0; i < r; i++) {
          ...
          ;((t.primitive && null == r) || ('sqrt' === t.type && 1 === i && null == s[0])) &&
            (r = 'primitive')
    ...
    const Gn = function(e, t, r) {
        ...
        return (
          o.setAttribute('title', e.toString()), o.setAttribute('style', 'color:' + r.errorColor), o
        )
      },
      Un = function(e, t) {
        const r = new m(t)
