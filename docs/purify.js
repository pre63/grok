...
!(function(e, t) {
  ...
  var Z = (function t() {
    ...
    const o = e => t(e)
    if (((o.version = '3.0.9'), (o.removed = []), !n || !n.document || 9 !== n.document.nodeType))
    ...
    let { IS_ALLOWED_URI: he } = K,
      ge = null
    const Te = S({}, [...L, ...x, ...v, ...k, ...I])
    let ye = null
    const Ee = S({}, [...M, ...U, ...P, ...F])
    let Ae = Object.seal(
        l(null, {
    ...
    let Ve = Ke,
      $e = !1,
      Ze = null
    const Je = S({}, [qe, Xe, Ke], d)
    let Qe = null
    const et = ['application/xhtml+xml', 'text/html'],
      tt = 'text/html'
    let nt = null,
      ot = null
    const rt = r.createElement('form'),
      it = function(e) {
      ...
      at = function() {
        ...
        if (!ot || ot !== e) {
          if (
            ((e && 'object' == typeof e) || (e = {}),
            (e = w(e)),
            (Qe = -1 === et.indexOf(e.PARSER_MEDIA_TYPE) ? tt : e.PARSER_MEDIA_TYPE),
            (nt = 'application/xhtml+xml' === Qe ? d : p),
            (ge = E(e, 'ALLOWED_TAGS') ? S({}, e.ALLOWED_TAGS, nt) : Te),
            (ye = E(e, 'ALLOWED_ATTR') ? S({}, e.ALLOWED_ATTR, nt) : Ee),
            (Ze = E(e, 'ALLOWED_NAMESPACES') ? S({}, e.ALLOWED_NAMESPACES, d) : Je),
            (Ye = E(e, 'ADD_URI_SAFE_ATTR') ? S(w(je), e.ADD_URI_SAFE_ATTR, nt) : je),
            (We = E(e, 'ADD_DATA_URI_TAGS') ? S(w(Ge), e.ADD_DATA_URI_TAGS, nt) : Ge),
            (ze = E(e, 'FORBID_CONTENTS') ? S({}, e.FORBID_CONTENTS, nt) : Be),
            (_e = E(e, 'FORBID_TAGS') ? S({}, e.FORBID_TAGS, nt) : {}),
            (be = E(e, 'FORBID_ATTR') ? S({}, e.FORBID_ATTR, nt) : {}),
            (He = !!E(e, 'USE_PROFILES') && e.USE_PROFILES),
            ...
            He &&
              ((ge = S({}, I)),
              (ye = []),
              !0 === He.html && (S(ge, L), S(ye, M)),
              !0 === He.svg && (S(ge, x), S(ye, U), S(ye, F)),
              !0 === He.svgFilters && (S(ge, v), S(ye, U), S(ye, F)),
              !0 === He.mathMl && (S(ge, k), S(ye, P), S(ye, F))),
            e.ADD_TAGS && (ge === Te && (ge = w(ge)), S(ge, e.ADD_TAGS, nt)),
            e.ADD_ATTR && (ye === Ee && (ye = w(ye)), S(ye, e.ADD_ATTR, nt)),
            e.ADD_URI_SAFE_ATTR && S(Ye, e.ADD_URI_SAFE_ATTR, nt),
            e.FORBID_CONTENTS && (ze === Be && (ze = w(ze)), S(ze, e.FORBID_CONTENTS, nt)),
            Pe && (ge['#text'] = !0),
            Le && S(ge, ['html', 'head', 'body']),
            ge.table && (S(ge, ['tbody']), delete _e.tbody),
      ...
      lt = S({}, ['mi', 'mo', 'mn', 'ms', 'mtext']),
      ct = S({}, ['foreignobject', 'desc', 'title', 'annotation-xml']),
      st = S({}, ['title', 'style', 'font', 'a', 'script']),
      ut = S({}, [...x, ...v, ...C]),
      mt = S({}, [...k, ...O]),
      ft = function(e) {
        let t = Q(e)
            ...
            : e.namespaceURI === qe
              ...
              : e.namespaceURI === Ke
                ? !(t.namespaceURI === Xe && !ct[o]) &&
                  (!(t.namespaceURI === qe && !lt[o]) && (!mt[n] && (st[n] || !ut[n])))
                : !('application/xhtml+xml' !== Qe || !Ze[e.namespaceURI])))
      },
      pt = function(e) {
      ...
      ht = function(e) {
        ...
        if (!t || !t.documentElement) {
          ...
          try {
            t.documentElement.innerHTML = $e ? te : o
          } catch (e) {}
        }
        const i = t.body || t.documentElement
        return (
          e && n && i.insertBefore(r.createTextNode(n), i.childNodes[0] || null),
          Ve === Ke ? ie.call(t, Le ? 'html' : 'body')[0] : Le ? t.documentElement : i
        )
      },
      gt = function(e) {
        return oe.call(e.ownerDocument || e, e, H.SHOW_ELEMENT | H.SHOW_COMMENT | H.SHOW_TEXT, null)
      },
      Tt = function(e) {
        return (
          e instanceof B &&
      ...
      At = function(e) {
        let t = null
        if ((Et('beforeSanitizeElements', e, null), Tt(e))) return pt(e), !0
        const n = nt(e.nodeName)
        if (
          (Et('uponSanitizeElement', e, { tagName: n, allowedTags: ge }),
          e.hasChildNodes() &&
        ...
        if (!ge[n] || _e[n]) {
          if (!_e[n] && bt(n)) {
            if (Ae.tagNameCheck instanceof RegExp && A(Ae.tagNameCheck, n)) return !1
          ...
          if (Pe && !ze[n]) {
            const t = Q(e) || e.parentNode,
              n = J(e) || e.childNodes
            if (n && t) {
              for (let o = n.length - 1; o >= 0; --o) t.insertBefore(q(n[o], !0), Z(e))
            }
          }
          return pt(e), !0
        }
        return e instanceof R && !ft(e)
          ? (pt(e), !0)
      ...
      _t = function(e, t, n) {
        if (Ie && ('id' === t || 'name' === t) && (n in r || n in rt)) return !1
        if (Se && !be[t] && A(me, t));
        else if (Ne && A(fe, t));
        else if (!ye[t] || be[t]) {
          if (
            !(
              (bt(e) &&
                ((Ae.tagNameCheck instanceof RegExp && A(Ae.tagNameCheck, e)) ||
                  (Ae.tagNameCheck instanceof Function && Ae.tagNameCheck(e))) &&
                ((Ae.attributeNameCheck instanceof RegExp && A(Ae.attributeNameCheck, t)) ||
                  (Ae.attributeNameCheck instanceof Function && Ae.attributeNameCheck(t)))) ||
              ('is' === t &&
                Ae.allowCustomizedBuiltInElements &&
                ((Ae.tagNameCheck instanceof RegExp && A(Ae.tagNameCheck, n)) ||
      ...
      Nt = function(e) {
        ...
        for (; r--; ) {
          ...
          if (
            ...
            Et('uponSanitizeAttribute', e, n),
            (f = n.attrValue),
            n.forceKeepAttr))
            continue
          if ((dt(a, e), !n.keepAttr)) continue
          if (!we && A(/\/>/i, f)) {
            dt(a, e)
            continue
          }
          ...
          const p = nt(e.nodeName)
          if (_t(p, s, f)) {
            if (
              (!Me || ('id' !== s && 'name' !== s) || (dt(a, e), (f = Ue + f)),
      ...
      St = function e(t) {
        let n = null
        const o = gt(t)
        for (Et('beforeSanitizeShadowDOM', t, null); (n = o.nextNode()); )
          Et('uponSanitizeShadowNode', n, null),
            At(n) || (n.content instanceof s && e(n.content), Nt(n))
    ...
    return (
      (o.sanitize = function(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          i = null,
          l = null
        if ((($e = !e), $e && (e = '\x3c!--\x3e'), 'string' != typeof e && !yt(e))) {
        ...
        if ((xe || at(t), (o.removed = []), 'string' == typeof e && (Fe = !1), Fe)) {
          if (e.nodeName) {
            const t = nt(e.nodeName)
            if (!ge[t] || _e[t]) throw _('root node is forbidden and cannot be sanitized in-place')
          }
          ...
          if (!Ce && !De && !Le && -1 === e.indexOf('<')) return ee && Oe ? ee.createHTML(e) : e
          if (((n = ht(e)), !n)) return Ce ? null : Oe ? te : ''
        }
        n && ve && pt(n.firstChild)
        const c = gt(Fe ? e : n)
        for (; (i = c.nextNode()); ) At(i) || (i.content instanceof s && St(i.content), Nt(i))
        if (Fe) return e
        if (Ce) {
          if (ke) for (l = re.call(n.ownerDocument); n.firstChild; ) l.appendChild(n.firstChild)
          else l = n
          return (ye.shadowroot || ye.shadowrootmode) && (l = ae.call(a, l, !0)), l
        }
        let m = Le ? n.outerHTML : n.innerHTML
        return (
          Le &&
            ge['!doctype'] &&
            n.ownerDocument &&
